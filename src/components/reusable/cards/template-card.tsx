...
import { NotepadTextDashed, PencilLine, Trash2 } from 'lucide-react'
  ...
  return (
    <>
      <CardWrapper {...rest}>
        {!hidePopover && (
          <CardPopover>
            <LLink href={`${getDashboardURLPath()}/bots/create?template=${template._id}`}>
              <CardPopoverContent text='Create bot' icon={<NotepadTextDashed />} />
            </LLink>
