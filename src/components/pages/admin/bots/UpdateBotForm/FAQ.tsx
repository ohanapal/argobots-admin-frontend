  ...
  return (
    <FormWrapper>
      ...
      <Input
        ...
        label='Question*'
        hint='Enter a commonly asked question. Think about what users frequently inquire about regarding your product or service.'
      />
      <Textarea
        value={faq.objective}
        ...
        label='Objective*'
        hint='State the goal or purpose of this FAQ entry. Explain what you aim to clarify or help users understand.'
      />
