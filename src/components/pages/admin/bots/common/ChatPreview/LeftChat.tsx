...
export default function LeftChat({ message, imgSrc, sources, isDark }: Props) {
  const { secondary_color, secondary_color_dark, secondary_font_color, secondary_font_color_dark } = { ...sources }
        ...
        >
          <div
            ...
            style={{
              color: isDark ? secondary_font_color_dark : secondary_font_color,
              // @ts-ignore
              '--tw-prose-body': isDark ? secondary_font_color_dark : secondary_font_color,
              '--tw-prose-headings': isDark ? secondary_font_color_dark : secondary_font_color,
              '--tw-prose-bullets': isDark ? secondary_font_color_dark : secondary_font_color
            }}
