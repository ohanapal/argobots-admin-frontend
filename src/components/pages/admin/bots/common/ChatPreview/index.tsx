...
import { ColorPalette } from '@/constants/bot/color_palletes'
...
export default function ChatPreview() {
  ...
  const color_palette: ColorPalette = watch('color_palette')
  const {
    primary_color,
    primary_color_dark,
    secondary_color,
  ...
  return (
    <div className='space-y-4'>
      <Typography variant='h5'>Bot Preview</Typography>
      <div
      ...
      >
        <div
          ...
          className={cn('p-2 flex flex-wrap items-center justify-between')}
        >
          <div className={cn('flex items-center gap-3')}>
            <div className='size-12 rounded-lg overflow-hidden'>
              {getSrc(logo_light, logo_dark) ? (
                <Img src={getSrc(logo_light, logo_dark)} alt='' className='size-full aspect-square object-cover' />
              ) : (
                <Img src={companyPlaceholder} alt='' className='size-full aspect-square object-cover' />
              )}
            </div>
        ...
        <div
          ...
          style={{
            ...
            color: isDark ? primary_font_color_dark : primary_font_color
          }}
        >
          <RightChat
            message={
            ...
            imgSrc={user_logo}
            sources={{ primary_color, primary_color_dark, secondary_font_color, secondary_font_color_dark }}
            isDark={isDark}
          />
          <LeftChat
            ...
            imgSrc={bot_logo}
            sources={{ secondary_color, secondary_color_dark, secondary_font_color, secondary_font_color_dark }}
            isDark={isDark}
          />
          <RightChat
