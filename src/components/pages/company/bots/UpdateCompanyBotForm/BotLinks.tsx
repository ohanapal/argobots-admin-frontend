  ...
  return (
    <FormWrapper>
      ...
      <Textarea
        ...
        label='Link*'
        hint="Enter the URL that the bot will direct users to. This link should provide further information or actions relevant to your bot's purpose."
      />
      <Textarea
        ...
        label='Objective*'
        hint='Describe the purpose of this link. Explain what users will gain or learn from visiting this URL.'
      />
